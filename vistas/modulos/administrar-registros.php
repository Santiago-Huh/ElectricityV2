          ...
          <div class="modal-body">
            <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="nombre de proyecto" readonly id="nomP" name="nomP">
                <input  type="hidden" name="idProyect" id="idProyect" required>
                <input  type="hidden" name="idRegistro" id="idRegistro" required>
                <!--<input  type="hidden" name="nomP" id="nomP" required>-->
              </div>
              <br>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4">
                      <div class="form-group">
                          <label>Calle</label>
                          <input class="form-control" type="text" placeholder="editarCalle" id="editarCalle" name="editarCalle">
                      </div>
                  </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4">
                      <div class="form-group">
                          ...
                          <input class="form-control" type="text" id="editarInstalador" name="editarInstalador">
                  </div>
                </div>
             ...
             <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="editarModelo" name="editarModelo">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text"id="editarPotencia" name="editarPotencia">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    <label>Instalación de varilla a tierra</label>
                    <select class="form-control" name="editarInstaVT" id="editarInstaVT">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    <label>Instalación de cables para fases</label>
                    <select class="form-control" name="editarInstaCF" id="editarInstaCF">
                      <option value="Si">Si</option>
                      <option value="No">No</option>
                    </select>
                  </div>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    <label>Instalación de cable desnudo para tierra</label>
                    <select class="form-control" name="editarInstaCD" id="editarInstaCD">
                      <option value="Si">Si</option>
                      <option value="No">No</option>
                    </select>
                  </div>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    <label>Instalación de brazo de poste</label>
                    <select class="form-control" name="editarInstaBP" id="editarInstaBP">
                      <option value="Si">Si</option>
                      <option value="No">No</option>
                    </select>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <label>Instalación de tubo galvanizado en poste de concreto</label>
                    <select class="form-control" name="editarInstaTGPC" id="editarInstaTGPC">
                      <option value="Si">Si</option>
                      <option value="No">No</option>
                    </select>
                  </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control input-lg" cols="50" name="editarObser" id="editarObser"></textarea>
