...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Gestionar PYC</li>
        ...
        <?php
          ...
          foreach ($pyc as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td class="text-uppercase">'.$value["nomP"].'</td>
                    <td class="text-uppercase">'.$value["lugar"].'</td>
                    <td class="text-uppercase">'.$value["comV"].'</td>
                    <td class="text-uppercase">'.$value["comOP"].'</td>
                    <!--<td class="text-uppercase">'./*$value["comO"].*/'</td>
                    <td class="text-uppercase">'./*$value["sysI"].*/'</td>-->
                    <td class="text-uppercase">'.$value["sysC"].'</td>
                    <td class="text-uppercase">'.$value["sysS"].'</td>
                    <td class="text-uppercase">'.$value["weeks"].'</td>
                    <td class="text-uppercase">'.$value["aliPD"].'</td>
                    <td class="text-uppercase">'.$value["costoH"].'</td>
                    <td class="text-uppercase">'.$value["costoP"].'</td>
                    <td class="text-uppercase">'.$value["cashET"].'</td>
                    <td class="text-uppercase">'.$value["cashE"].'</td>
                    <td class="text-uppercase">'.$value["costoT"].'</td>
                    <td class="text-uppercase">'.$value["costoS"].'</td>
                    <td class="text-uppercase">'.$value["costoD"].'</td>
                    <td class="text-uppercase">'.$value["observacion"].'</td>

                    <td>

                      <div class="btn-group">
                          
                        <button class="btn btn-warning btnEditarPYC" data-toggle="modal" data-target="#modalEditarPYC" idPyc="'.$value["idP"].'"><i class="fa fa-pencil"></i></button>';
