...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tabla Proyectos</li>
        ...
        <?php
          ...
          foreach ($proyectos as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td class="text-uppercase">'.$value["clientep"].'</td>
                    <td class="text-uppercase">'.$value["lugar"].'</td>
                    <td class="text-uppercase">'.$newDateI.'</td>
                    <td class="text-uppercase">'.$newDateF.'</td>
                    <td class="text-uppercase">'.$value["trabR"].'</td>
                    <td class="text-uppercase">'.$value["marcaL"].'</td>
                    <td class="text-uppercase">'.$value["descripM"].'</td>
                    <td class="text-uppercase">'.$value["cantL"].'</td>
                    <td class="text-uppercase">'.$value["tipoV"].'</td>
                    <td class="text-uppercase">'.$value["consider"].'</td>
                    <td class="text-uppercase">'.$value["obvser"].'</td>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-info btnVerProgresoMate" idProgremate="'.$value["id"].'"><i class="fa fa-gears"></i></button>';
  ...
  <div class="modal-dialog">
    ...
    <div class="box-body">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control input-lg" name="editarM" id="editarM" required>
        </div>
