           ...
           <form role="form">
             <div class="box-body">
               ...
               <div class="form-group">
                 ...
                 <input type="number" class="form-control" id="input6" onkeyup="combusOP()" min="0" placeholder="Número de Sobreestantes">
               </div>
           ...
           <form role="form" method="post">
             ...
             <label for="exampleInputPassword1">Combustible para viaje</label>
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" id="res1" name="res1" readonly>
                </div>
                  <br>
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fas fa-gas-pump"></i></span>
                    <input type="text" class="form-control" id="res2" name="res2" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class=""></i></span>
                    <input type="text" class="form-control" id="res5" name="res5" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class=""></i></span>
                    <input type="text" class="form-control" id="res6" name="res6" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="res7" name="res7" readonly>
                </div>
                  <br>
                <div class="form-group" style="display:none;">
                 <label for="exampleInputPassword1">Alimentos por día</label>
                 <input type="number" class="form-control" id="res12" name="res12" min="0" placeholder="Alimentos (por día)" readonly>
               </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="res9" name="res9" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="res10" name="res10" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="res13" name="res13" readonly>
                </div>
                    <br>
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fas fa-money-bill"></i></span>
                    <input type="text" class="form-control" id="res11" name="res11" readonly>
                </div>
                    <br>
                ...
                <div class="input-group small-box bg-green">
                    <span class="input-group-addon"><i class="fas fa-money-bill"></i></span>
                    <input type="text" class="form-control" id="totalFF" name="totalFF" readonly>
                </div>
                    <br>    
                ...
                <div class="input-group small-box bg-green">
                    <span class="input-group-addon"><i class="fas fa-money-bill"></i></span>
                    <input type="text" class="form-control" id="totalS" name="totalS" readonly>
                </div>
                    <br>
                ...
                <div class="input-group small-box bg-green">
                    <span class="input-group-addon"><i class="fas fa-money-bill"></i></span>
                    <input type="text" class="form-control" id="totalD" name="totalD" readonly>
                </div>
                    <br>
...
function totalF(){
    ...
    let res13 = Number(document.getElementById('res13').value);
