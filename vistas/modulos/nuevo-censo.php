              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Altura en metros" id="alturaP" name="alturaP">
              ...
              <div class="row">
                ...
                <h4>Tipo de vialidad</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label>
                            <input type="radio" name="vialidad" id="optionsRadios1" value="Primaria" checked="">
                            Primaria
                            </label>
                        </div>
                    <div class="radio">
              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="distanciaI" name="distanciaI" placeholder="Distancia (m)">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="cos" name="cos" placeholder="ID de luminaria">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Latitud" id="latitud" name="latitud">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Longitud" id="longitud" name="longitud">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Instalador" id="instalador" name="instalador">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Modelo de luminaria existente" id="luminariaexistente" name="luminariaexistente">
